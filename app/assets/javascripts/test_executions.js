...
var initializeTestExecutionResults = function() {
  // activate the tabs
  $(".file-error-tabs").tabs();
  $(".file-error-tabs > ul > li").removeClass("ui-corner-top");
  $("#xml-tabs").tabs().addClass("ui-tabs-vertical ui-helper-clearfix");
  $("#xml-tabs > ul > li").removeClass("ui-corner-top");

  // disable tabs with no errors and set active tab
  $("#display_execution_results .ui-tabs").each(function() {
    var disabledTabs = [];
    var enabledTabs = [];
